...
export default function StocksTab(props) {
  const tabs = [
    { name: "Overview", href: "#", current: props.curr === "1" },
    { name: "Stocks", href: "#", current: props.curr === "2" },
    { name: "Crypto", href: "#", current: props.curr === "3" },
    { name: "Economic Calendar", href: "#", current: props.curr === "4" },
    { name: "Cross Rates", href: "#", current: props.curr === "5" },
  ];
    ...
    <div className="bg-gray-900 px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="hidden sm:block">
          <nav className="flex border-b border-white/10 py-3">
            <ul
              role="list"
